...
- party_id_mask 必須且只能從 DM_S_VIEW.M_AC_ACCOUNT 取得：JOIN DM_S_VIEW.M_AC_ACCOUNT ON <主表>.party_id = M_AC_ACCOUNT.party_id，再 SELECT M_AC_ACCOUNT.party_id_mask；禁止直接 SELECT 其他表格的 party_id_mask。
